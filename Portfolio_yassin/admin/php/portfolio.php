     ...
     <div class="form-row">
         ...
         <div class="form-group col-md-12">
             ...
             <input type="text" name="projectlink" class="form-control" id="email"
                 placeholder="https://whomonugiri.github.io/todo-list-maker/">
         </div>
 ...
 <table class="table table-striped table-sm">
    ...
    ?>
            <tr>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="post" action="php/uportfolio.php" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            <img src="../dist/img/projects/<?=$data2['projectpic']?>"
                                                class="oo img-thumbnail">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>Project Screenshot/Image (Minimum 600px X 600px, Maxsize 2mb)</label>
                                            <div class="custom-file">
                                        ...
                                        <div class="form-group col-md-6 mt-auto">
                                            ...
                                            <input type="name" name="projectname" value="<?=$data2['projectname']?>"
                                                class="form-control" id="name" placeholder="ToDo List Maker">
                                        </div>
                                        ...
                                        <div class="form-group col-md-12">
                                            <label for="email">Project Link</label>
                                            <input type="text" name="projectlink" value="<?=$data2['projectlink']?>"
             ...
             <td>#<?=$count?></td>
             <td><img src="../dist/img/projects/<?=$data2['projectpic']?>" class="oo img-thumbnail"></td>
             <td><?=$data2['projectname']?></td>
             <td>
                 <a href="<?=$data2['projectlink']?>"> <button type="button"
                         class="btn btn-success btn-sm">Visit</button></a>

                 <button type="button" class="btn btn-primary btn-sm" data-toggle="modal"
                     data-target="#modal<?=$data2['id']?>">
                     Edit
                 </button> <a href="php/uportfolio.php?del=<?=$data2['id']?>"><button type="button"
